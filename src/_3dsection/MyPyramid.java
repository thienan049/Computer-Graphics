...
import java.io.BufferedWriter;
    ...
    public void makePyramid(int x, int y, int z){
        y = y/2;       
        setDt1(new MyLine(new Point(400,250),new Point(400+x,250))); //ox
        setDt2(new MyLine(new Point(400-y,250+y),new Point(400,250))); //oy
        setDt3(new MyLine(new Point(400-y,250+y),new Point(400+x,250))); 
        setDt4(new MyLine(new Point(400,250),new Point(400-y+x,250+y))); 
        setDt5(new MyLine(new Point(400-y/2+x/2,250+y/2),new Point(400-y/2+x/2,250+y/2-z))); // cao
        setDt6(new MyLine(new Point(400,250),new Point(400-y/2+x/2,250+y/2-z))); 
        setDt7(new MyLine(new Point(400-y/2+x/2,250+y/2-z),new Point(400+x,250))); 
        setDt8(new MyLine(new Point(400-y/2+x/2,250+y/2-z),new Point(400-y,250+y))); 
        setDt9(new MyLine(new Point(400-y/2+x/2,250+y/2-z),new Point(400+x-y,250+y))); 
        setDt10(new MyLine(new Point(400-y,250+y),new Point(400+x-y,250+y))); 
        setDt11(new MyLine(new Point(400+x,250),new Point(400+x-y,250+y))); 
  
        MyLine temp = new MyLine(new Point(400,250),new Point(400,0));
        if((getDt8().GiaoDiem(temp).y < 250) && (getDt8().GiaoDiem(temp).y > getDt7().GiaoDiem(temp).y))       
            setDt12(new MyLine(new Point(400,250),getDt8().GiaoDiem(temp))); //oz
        else if((getDt8().GiaoDiem(temp).y < 250) && (getDt8().GiaoDiem(temp).y < getDt7().GiaoDiem(temp).y))
            setDt12(new MyLine(new Point(400,250),getDt7().GiaoDiem(temp)));
        else
            setDt12(new MyLine(new Point(400,250),new Point(400,250)));
    }
